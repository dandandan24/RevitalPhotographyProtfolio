    ...
    packages: [
      ...
      },
      {
        ...
        offers: [
          ...
          'הצילומים יכללו צילומי תדמית אישיים וכן תמונות אווירה',
          'ייעוץ סטיילניג טרם הצילומים',
          '15 תמונות ערוכות באיכות גבוהה כולל פוטושוט',
          'ליווי וייעוץ סטיילינג טרום הצילומים –<br>בשווי 300 ₪ - במתנה!'
        ]
      }
    ]
    ...
    packages: [
      {
        ...
        offers: [
          'לוקיישן לבחירה',
          '100 תמונות ערוכות באיכות גבוהה',
          'ליווי וייעוץ סטיילינג טרום הצילומים –<br>בשווי 300 ₪ - במתנה!',
          'אלבום מודפס מעוצב בגודל 25*50 מצב פתוח (30 עמודים)',
          'תמונה ממוסגרת ומודפסת 20×20',
          'גלריה דיגיטלית מעוצבת לשיתוף עם המשפחה והחברים',
          '10 תמונות מודפסות לבחירתכם 10x15 ס"מ'
        ]
      },
      {
              ...
              <div className="lg:hidden py-4 flex justify-center">
                <div className="relative w-56">
                  <select
                    ...
                    className="w-full px-5 py-3 text-base font-medium text-black bg-white/10 backdrop-blur-xl border-2 border-[#F1BDAF] rounded-lg shadow-md appearance-none cursor-pointer hover:bg-[#F1BDAF]/10 transition-all duration-200 text-center"
                    dir="rtl"
                  >
              ...
              return sortedPackages.map((pkg) => (
                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-grow" dir="rtl">
                    ...
                    <div className="text-2xl font-bold w-full flex justify-center mb-3" style={{ color: '#F1BDAF' }}>
                        {pkg.price} בלבד
                      </div>
                    {/* Order Button - Always at bottom */}
                    <Button asChild variant="standard" className="w-full mt-auto">
                      <Link href="/Contact">שריינו עכשיו</Link>
                    </Button>
                  </div>
                </div>
              ));
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        <div className="text-right">
          ...
          <div className="mt-4 text-sm text-gray-500" dir="rtl">
            <h2 className="mb-2 text-lg" style={{ color: '#F1BDAF' }}>תוספות</h2>
            ...
            {(selectedCategory !== 'הריון' && selectedCategory !== 'גיל מצווה' && selectedCategory !== 'דורות') && <p>מצולם נוסף בתוספת של 150₪</p>}
            <p className="mt-4">המחירים והחבילות אינם סופיים ונתונים לשיקול דעתה של הצלמת.</p>
